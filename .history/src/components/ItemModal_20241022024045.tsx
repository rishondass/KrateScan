        ...
        <div className='bg-white rounded-md h-4/5 w-11/12 p-2'>
          ...
          <div className='grid grid-cols-2 gap-2'>
            <div className='flex flex-col'>
              ...
              <input type="text" defaultValue={} className='outline-none bg-gray-200 rounded-md h-10 p-2' onChange={(e)=>{setItemInfo({...itemInfo,name:e.target.value})}}/>
            </div>
            <div className='flex flex-col'>
              <label htmlFor="location">Quantity:</label>
              <input type="text" className='outline-none bg-gray-200 rounded-md h-10 p-2' onChange={(e)=>{setItemInfo({...itemInfo,quantity: parseInt(e.target.value)})}}/>
            </div>
