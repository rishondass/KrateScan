        ...
        <div className='bg-white rounded-md h-4/5 w-11/12 p-2'>
          ...
          <div className='grid grid-cols-2 gap-2'>
            ...
            <div className='flex flex-col col-span-2'>
              ...
              <textarea name="" id="" defaultValue={quantity} className='outline-none bg-gray-200 rounded-md h-36 p-2' onChange={(e)=>{setItemInfo({...itemInfo,description:e.target.value})}}></textarea>
            </div>
            {dataUri?
